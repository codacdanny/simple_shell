...
/**
 * cd_dot - Function that changes working dir to the parent directory
 *
...
/**
 * cd_to - Function that changes wd to a directory given
 * by the user
 *
...
/**
 * cd_previous - Function that changes wd to the previous directory
 *
 * @datash: data relevant (environ)
 * Return: NULL
 */
...
/**
 * cd_to_home - Function that changes wd to home directory
 *
 * @datash: data relevant (environ)
 * Return: NULL
 */
